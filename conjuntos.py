...
# Tupla aceitem valores duplicados então temos 10 elementos
...
cidades = ['Belo Horizonte', 'São Paulo', 'Pernambuco', 'Cuiaba', 'Pernambuco', 'São Paulo', 'Cuiaba']
...
estudantes_python = {'Marcos', 'Patricia', 'Ellen', 'Pedro', 'Luiz', 'Beatriz'}
estudantes_java = {'Fernando', 'Gustavo', 'Julia', 'Ana', 'Patricia'}

# Veja que alguns estudam Python e também estudam Java.
...
# unico1 = estudantes_java.unicon(estudantes_python)
# {'Julia', 'Patricia', 'Marcos', 'Beatriz', 'Pedro', 'Fernando', 'Gustavo', 'Luiz', 'Ellen', 'Ana'}
print(unicos1)

# Forma 2 - Utilizando o caratere pipe |
...
# Gera um conjunto de estudantes que não estão no outro curso
